...
echo "=== [pip 6-8/10] installing torch, torchvision, torchaudio (cu128) ==="
conda run -n tqdne pip install torch==2.11.0 torchvision==0.26.0 torchaudio==2.11.0 --index-url https://download.pytorch.org/whl/cu128
...
echo "=== [pip 10/10] installing tqdne local package (editable install) ==="
