...
echo "=== [pip 4/8] installing torch, torchvision, torchaudio (cu128) ==="
conda run -n tqdne_stead pip install torch==2.11.0 torchvision==0.26.0 torchaudio==2.11.0 --index-url https://download.pytorch.org/whl/cu128
